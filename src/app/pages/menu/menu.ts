...
export class MenuComponent implements OnInit {
  ...
  // Aquí va tu lista de menuPorSecciones exactamente igual que en el paso anterior
  menuPorSecciones: any[] = [
    {
    ...
    },
    {
      ...
      platillos: [
        { id: 12, nombre: 'Tokio Roll', descripcion: 'Dentro: Camarón, Queso Crema, Pepino, Aguacate', precio: 130.00, imagenUrl: '' }, // Falta Imagen
        ...
        { id: 14, nombre: 'Vegetariano', descripcion: 'Dentro: Zanahoria, Queso Crema, Pepino, Aguacate. Fuera: Queso Crema, Ajonjolí', precio: 130.00, imagenUrl: ''}, //Falta Imagen
    ...
    },
    {
      ...
      platillos: [
        ...
        {id: 36, nombre: 'Bacon', descripcion: 'Arroz Frito, Calabaza, Zanahoria, Pollo, Tocino, Queso, Aguacate, Cebollín y Ajonjolí', precio: 140.00 , imagenUrl: ''} // Falta Imagen
      ]
    },
    {
      categoria: 'Infantil',
      platillos: [
        {id: 37, nombre: 'Esferas del Dragón', descripcion: 'Bolas de Arroz Rellenas de Queso Crema', precio: 119.00, imagenUrl: ''}, //Falta Imagen
        ...
        {id: 40, nombre: 'Nuggets', descripcion: 'Pollo en trozos empanizado, Con Papas a la Francesa', precio: 119.00 , imagenUrl: 'https://vqveltibucqpnnshvgnf.supabase.co/storage/v1/object/public/menu-images/Nuggets.jpeg'}, // Falta Imagen
        {id: 41, nombre: 'Orden de Papas a la francesa', descripcion: 'Tiras de papa freidas', precio: 45.00 , imagenUrl: 'https://vqveltibucqpnnshvgnf.supabase.co/storage/v1/object/public/menu-images/Orden%20de%20Papas%20a%20la%20francesa.jpeg'} // Falta Imagen
    ...
    },
    {
      ...
      platillos: [
        ...
        {id: 43, nombre: 'Palomitas Chiri', descripcion: 'Empanizadas, Queso, Camarón y Serrano', precio: 130.00, imagenUrl: ''}, //Falta Imagen
        ...
        {id: 45, nombre: 'Pasta Kitsune', descripcion: 'Pasta a la Plancha Salteada con Arrachera, Camarón, Calabaza, Zanahoria, Guarnición de Arroz y Cebollín', precio: 155.00 , imagenUrl: 'https://vqveltibucqpnnshvgnf.supabase.co/storage/v1/object/public/menu-images/Pasta%20Kitsune.jpeg'}, // Falta Imagen
        ...
        {id: 49, nombre: 'Papas Chizu', descripcion: 'Papas a la Francesa Bañadas en Queso Amarillo con Topin de Tocino Crujiente y Chile Serrano Frito', precio: 65.00 , imagenUrl: ''} //Falta Imagen
  ...
  // 👇 NUEVO: Variable para recordar qué pestaña estamos viendo
  categoriaActiva: string = '';

  // 👇 NUEVO: Al iniciar la página, seleccionamos la primera categoría por defecto
  ngOnInit() {
    if (this.menuPorSecciones.length > 0) {
      this.categoriaActiva = this.menuPorSecciones[0].categoria;
    }
  }

  // 👇 NUEVO: Función para cambiar la pestaña cuando el usuario hace clic
  cambiarCategoria(nombreCategoria: string) {
    this.categoriaActiva = nombreCategoria;
  }

  agregarAlCarrito(platillo: any) {
    console.log('Añadiendo al carrito:', platillo.nombre);
  }
}